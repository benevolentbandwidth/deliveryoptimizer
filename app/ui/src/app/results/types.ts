...
// Type for pending pin move data (temporary data that gets committed to Route.stops on Save, cleared on Cancel / leaving edit mode)
export type PendingPinMove = {
  vehicleId: string;
  stopId: string;
  lat: number;
  lng: number;
